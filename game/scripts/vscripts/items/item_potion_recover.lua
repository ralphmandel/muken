item_potion_recover = class({})
LinkLuaModifier("item_potion_recover_modifier", "items/item_potion_recover_modifier", LUA_MODIFIER_MOTION_NONE)

function item_potion_recover:OnSpellStart()
	...
	caster:AddNewModifier(caster, self, "item_potion_recover_modifier", {duration = duration})
