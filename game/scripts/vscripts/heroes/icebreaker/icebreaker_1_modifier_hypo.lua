...
function icebreaker_1_modifier_hypo:OnCreated(kv)
	...
	if cosmetics then cosmetics:SetStatusEffect(nil, "icebreaker_1_modifier_hypo_status_efx", true) end
...
function icebreaker_1_modifier_hypo:OnRemoved(kv)
	local cosmetics = self.parent:FindAbilityByName("cosmetics")
	if cosmetics then cosmetics:SetStatusEffect(nil, "icebreaker_1_modifier_hypo_status_efx", false) end
