...
function icebreaker_3_modifier_passive:GetStatusEffectName()
    return ""
end

function icebreaker_3_modifier_passive:StatusEffectPriority()
	return MODIFIER_PRIORITY_NORMAL
end

function icebreaker_3_modifier_passive:GetEffectName()
	return ""
end

function icebreaker_3_modifier_passive:GetEffectAttachType()
	return PATTACH_ABSORIGIN_FOLLOW
end

function icebreaker_3_modifier_passive:PlayEfxStart(target)
	-- RELEASE PARTICLE
	local string_1 = ""
