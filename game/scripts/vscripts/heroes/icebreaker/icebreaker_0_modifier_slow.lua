...
function icebreaker_0_modifier_slow:OnCreated( kv )
	...
	if cosmetics then cosmetics:SetStatusEffect(nil, "icebreaker_0_modifier_slow_status_efx", true) end
...
function icebreaker_0_modifier_slow:OnRemoved( kv )
	local cosmetics = self.parent:FindAbilityByName("cosmetics")
	if cosmetics then cosmetics:SetStatusEffect(nil, "icebreaker_0_modifier_slow_status_efx", false) end
