...
function icebreaker_2_modifier_recharge:GetStatusEffectName()
    return ""
end

function icebreaker_2_modifier_recharge:StatusEffectPriority()
	return MODIFIER_PRIORITY_NORMAL
end

function icebreaker_2_modifier_recharge:GetEffectName()
	return ""
end

function icebreaker_2_modifier_recharge:GetEffectAttachType()
	return PATTACH_ABSORIGIN_FOLLOW
end

function icebreaker_2_modifier_recharge:PlayEfxStart(target)
	-- RELEASE PARTICLE
	local string_1 = ""
