...
function ancient_3_modifier_walk:OnCreated(kv)
  ...
  AddStatusEfx(self.ability, "ancient_3_modifier_walk_status_efx", self.caster, self.parent)
...
function ancient_3_modifier_walk:OnRemoved()
  ...
  RemoveStatusEfx(self.ability, "ancient_3_modifier_walk_status_efx", self.caster, self.parent)
end
