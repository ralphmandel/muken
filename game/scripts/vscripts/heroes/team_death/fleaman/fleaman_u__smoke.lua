...
LinkLuaModifier("fleaman_u_modifier_aura_effect", "heroes/team_death/fleaman/fleaman_u_modifier_aura_effect", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("fleaman_u_modifier_shadow", "heroes/team_death/fleaman/fleaman_u_modifier_shadow", LUA_MODIFIER_MOTION_NONE)
