...
LinkLuaModifier("bloodstained_5_modifier_passive_status_efx", "heroes/team_death/bloodstained/bloodstained_5_modifier_passive_status_efx", LUA_MODIFIER_MOTION_NONE)
