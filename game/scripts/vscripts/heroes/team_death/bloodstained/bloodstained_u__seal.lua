...
LinkLuaModifier("bloodstained__modifier_copy", "heroes/team_death/bloodstained/bloodstained__modifier_copy", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("bloodstained__modifier_copy_status_efx", "heroes/team_death/bloodstained/bloodstained__modifier_copy_status_efx", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("bloodstained__modifier_bloodstained", "heroes/team_death/bloodstained/bloodstained__modifier_bloodstained", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("bloodstained__modifier_bloodgain", "heroes/team_death/bloodstained/bloodstained__modifier_bloodgain", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("bloodstained__modifier_bloodloss", "heroes/team_death/bloodstained/bloodstained__modifier_bloodloss", LUA_MODIFIER_MOTION_NONE)
