...
LinkLuaModifier("druid_3_modifier_totem", "heroes/team_nature/druid/druid_3_modifier_totem", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("druid_3_modifier_flame", "heroes/team_nature/druid/druid_3_modifier_flame", LUA_MODIFIER_MOTION_NONE)
