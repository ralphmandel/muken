...
LinkLuaModifier("druid_4_modifier_fear", "heroes/team_nature/druid/druid_4_modifier_fear", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("druid_4_modifier_fear_status_efx", "heroes/team_nature/druid/druid_4_modifier_fear_status_efx", LUA_MODIFIER_MOTION_NONE)
