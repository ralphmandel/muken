...
LinkLuaModifier("icebreaker_4_modifier_passive", "heroes/team_moon/icebreaker/icebreaker_4_modifier_passive", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("icebreaker_4_modifier_invi", "heroes/team_moon/icebreaker/icebreaker_4_modifier_invi", LUA_MODIFIER_MOTION_NONE)
