...
LinkLuaModifier("icebreaker_3_modifier_shard", "heroes/team_moon/icebreaker/icebreaker_3_modifier_shard", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("icebreaker_3_modifier_aura_effect", "heroes/team_moon/icebreaker/icebreaker_3_modifier_aura_effect", LUA_MODIFIER_MOTION_NONE)
