...
LinkLuaModifier("genuine_3_modifier_travel", "heroes/moon_team/genuine/genuine_3_modifier_travel", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("genuine_3_modifier_orb", "heroes/moon_team/genuine/genuine_3_modifier_orb", LUA_MODIFIER_MOTION_NONE)
...
-- INIT
  ...
  function genuine_3__travel:GetAOERadius()
    return self:GetSpecialValueFor("silence_radius")
  end
