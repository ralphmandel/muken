...
--TALENT FUNCTIONS
	...
	function shadow__attributes:UpgradeRank(skill, id, level)
		...
		local ability = nil
		if skill == 0 then ability = caster:FindAbilityByName("shadow_0__toxin") end
		if skill == 1 then ability = caster:FindAbilityByName("shadow_1__strike") end
		if skill == 2 then ability = caster:FindAbilityByName("shadow_2__puddle") end
