bald_2__bash = class({})
LinkLuaModifier("bald_2_modifier_heap", "heroes/team_sun/bald/bald_2_modifier_heap", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("bald_2_modifier_dash", "heroes/team_sun/bald/bald_2_modifier_dash", LUA_MODIFIER_MOTION_HORIZONTAL)
LinkLuaModifier("bald_2_modifier_impact", "heroes/team_sun/bald/bald_2_modifier_impact", LUA_MODIFIER_MOTION_HORIZONTAL)
LinkLuaModifier("bald_2_modifier_gesture", "heroes/team_sun/bald/bald_2_modifier_gesture", LUA_MODIFIER_MOTION_HORIZONTAL)
