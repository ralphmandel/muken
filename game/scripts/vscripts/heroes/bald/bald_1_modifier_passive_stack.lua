...
function bald_1_modifier_passive_stack:IsPurgable()
	return true
end

function bald_1_modifier_passive_stack:IsHidden()
	return true
end

function bald_1_modifier_passive_stack:IsDebuff()
	return false
end

function bald_1_modifier_passive_stack:GetAttributes()
