...
function druid_4_modifier_fear:IsHidden()
    return false
end

function druid_4_modifier_fear:IsPurgable()
    return true
end

function druid_4_modifier_fear:IsDebuff()
    return true
end
...
function druid_4_modifier_fear:ApplyFear()
