...
--TALENT FUNCTIONS
	...
	druid__attributes.skills = {
		[1] = "druid_1__conversion",
		[2] = "druid_2__root",
		[3] = "druid_3__totem",
		[4] = "druid_u__seed"
	}
...
--PRECACHE
	function druid__attributes:Precache(context)
		...
		PrecacheResource("particle", "particles/druid/druid_skill1_cast_circle_leaf.vpcf", context)
		...
		PrecacheResource("particle", "particles/druid/druid_skill3_totem.vpcf", context)
		PrecacheResource("particle", "particles/druid/druid_ult_projectile.vpcf", context)
		PrecacheResource("particle", "particles/druid/druid_seed_buff.vpcf", context)
