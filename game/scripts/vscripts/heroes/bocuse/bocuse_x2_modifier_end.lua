bocuse_x2_modifier_end = class ({})

function bocuse_x2_modifier_end:IsHidden()
    return true
end

function bocuse_x2_modifier_end:IsPurgable()
    return false
end

-----------------------------------------------------------

function bocuse_x2_modifier_end:OnCreated(kv)
...
function bocuse_x2_modifier_end:OnRefresh(kv)
end

function bocuse_x2_modifier_end:OnRemoved()
...
function bocuse_x2_modifier_end:DeclareFunctions()
	local funcs = {
...
function bocuse_x2_modifier_end:GetModifierAttackRangeBonus()
    return self.range * 0.016
end

function bocuse_x2_modifier_end:OnIntervalThink()
...
function bocuse_x2_modifier_end:PlayEfxStart()
