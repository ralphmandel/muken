...
function bocuse_u_modifier_exhaustion:OnCreated(kv)
	...
	if cosmetics then cosmetics:SetStatusEffect("bocuse_u_modifier_exhaustion_status_efx", true) end
end
...
function bocuse_u_modifier_exhaustion:OnRemoved()
	local cosmetics = self.parent:FindAbilityByName("cosmetics")
	if cosmetics then cosmetics:SetStatusEffect("bocuse_u_modifier_exhaustion_status_efx", false) end
end
