...
function hunter_special_values:GetModifierOverrideAbilitySpecial(keys)
	...
	if ability:GetAbilityName() == "hunter_2__camouflage" then
		...
		if caster:FindAbilityByName("hunter_2__camouflage_rank_11") then
		end

    if caster:FindAbilityByName("hunter_2__camouflage_rank_12") then
		end

		if caster:FindAbilityByName("hunter_2__camouflage_rank_21") then
		end

    if caster:FindAbilityByName("hunter_2__camouflage_rank_22") then
		end

		if caster:FindAbilityByName("hunter_2__camouflage_rank_31") then
		end

    if caster:FindAbilityByName("hunter_2__camouflage_rank_32") then
		end

		if caster:FindAbilityByName("hunter_2__camouflage_rank_41") then
		end

    if caster:FindAbilityByName("hunter_2__camouflage_rank_42") then
		end
	end
	...
	if ability:GetAbilityName() == "hunter_u__aim" then
		if value_name == "AbilityManaCost" then return 1 end
		if value_name == "AbilityCooldown" then return 1 end
		if value_name == "rank" then return 1 end

		if caster:FindAbilityByName("hunter_u__aim_rank_11") then
		end

    if caster:FindAbilityByName("hunter_u__aim_rank_12") then
		end

		if caster:FindAbilityByName("hunter_u__aim_rank_21") then
		end

    if caster:FindAbilityByName("hunter_u__aim_rank_22") then
		end

		if caster:FindAbilityByName("hunter_u__aim_rank_31") then
		end

    if caster:FindAbilityByName("hunter_u__aim_rank_32") then
		end

		if caster:FindAbilityByName("hunter_u__aim_rank_41") then
		end

    if caster:FindAbilityByName("hunter_u__aim_rank_42") then
		end
	end
