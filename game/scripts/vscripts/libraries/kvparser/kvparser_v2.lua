...
--------------------------------------------------------------------------------
-- Class Definition
if KVParser then return end
KVParser = {}

-- edit dis
KVParser.PATH = "scripts/vscripts/libraries/kvparser/"
...
function KVParser:PrintingKV( inTable, level )
...
function KVParser:PrintKVToConsole( inTable, level )
	if not level then level = 0 end
...
function KVParser:GetKV( inTable, start )
