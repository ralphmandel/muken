...
function OnUpdateHeroSelection(event) {
  if (Game.GetState() == DOTA_GameState.DOTA_GAMERULES_STATE_HERO_SELECTION && event.splitscreenplayer == Game.GetLocalPlayerInfo().player_id) {
